...
static const char* patterns[] = {
    "\x00\x00\x00", "\x08\x88\x88", "\x11\x11\x11", "\x12\x49\x24", "\x19\x99\x99",
    "\x22\x22\x22", "\x24\x92\x49", "\x2a\xaa\xaa", "\x33\x33\x33", "\x36\xdb\x6d",
    "\x3b\xbb\xbb", "\x44\x44\x44", "\x49\x24\x92", "\x4c\xcc\xcc", "\x55\x55\x55",
    "\x5b\x6d\xb6", "\x5d\xdd\xdd", "\x66\x66\x66", "\x6d\xb6\xdb", "\x6e\xee\xee",
    "\x77\x77\x77", "\x7f\xff\xff", "\x80\x00\x00", "\x88\x88\x88", "\x91\x11\x11",
    "\x92\x49\x24", "\x99\x99\x99", "\xa2\x22\x22", "\xa4\x92\x49", "\xaa\xaa\xaa",
    "\xb3\x33\x33", "\xb6\xdb\x6d", "\xbb\xbb\xbb", "\xc4\x44\x44", "\xc9\x24\x92",
    "\xcc\xcc\xcc", "\xd5\x55\x55", "\xdb\x6d\xb6", "\xdd\xdd\xdd", "\xe6\x66\x66",
    "\xed\xb6\xdb", "\xee\xee\xee", "\xf7\x77\x77", "\xff\xff\xff", NULL
};
...
static int shred(char* path)
{
    ...
    UNUSED(path);
    fprintf(stderr, "%s: shred unimplemented on win32\n");
    return 1;
#else
    void*        buf;
    unsigned int i;
